 ...
 * @see com.tsystems.si.aviation.imf.atcHandle.db.bean.SysParameter
	...
	public SysParameter findById(java.lang.String id) {
		...
		try {
			SysParameter instance = (SysParameter) sessionFactory.getCurrentSession()
					.get("com.tsystems.si.aviation.imf.atcHandle.db.bean.SysParameter", id);
			if (instance == null) {
	...
	public List findByExample(SysParameter instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("com.tsystems.si.aviation.imf.atcHandle.db.bean.SysParameter")
